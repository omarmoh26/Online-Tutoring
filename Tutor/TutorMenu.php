<html>
	...
	<?php
		if(!empty($_SESSION['ID'])) 
		{
			...
			echo"<ul>";
			echo"<li><a href='TutorHome.php'><i class='fa fa-home' style='font-size:36px' ></i> Home </a></li>";
			echo"<li><a href='CoursesTutor.php'><i class='fas fa-laptop-code' style='font-size:36px'></i> Courses </a> </li>";
			echo"<li><a href='TutorAccount.php'><i class='fas fa-user-circle' style='font-size:36px'> </i> Account </a> </li>";
			echo "</ul>";
		}
		?>
