...
<table class="table table-striped">
    <thead class="thead-dark">
        ...
        $sendMessage = "INSERT INTO contactus (sent_by,received_by,message,createdAt,link,Image) VALUES('0','$receiver','$message','$createdAt','$l','$fileName')";
        mysqli_query($conn,$sendMessage) or trigger_error("<h1 style='color:red;'>Can't Send Your Message</h1>",E_USER_WARNING);
        }
        $getMessage = "SELECT  contactus.* ,user.Name FROM contactus INNER JOIN user on sent_by=user.UserID  WHERE sent_by='$receiver' and received_by = '0' or received_by='$receiver' OR sent_by = '0'  ORDER BY createdAt asc";
...
<div class="wrapper ">
    <form class= action="" method = "POST" enctype='multipart/form-data'>
        ...
        <input type="url" name="link"  placeholder="Paste The Course Link you want..." style="  background-color:lightgrey;"><br>
