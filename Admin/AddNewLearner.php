...
if(isset($_POST['Submit'])){
	...
	move_uploaded_file($_FILES['myfile']['tmp_name'],$dir.$fileName);
		...
		$sql="INSERT INTO user (Name,Email,Password,Type,Image)
				VALUES ('$sanitizedName','$sanitizedEmail','$sanitizedPass','learner','$fileName')";
		...
		{
			trigger_error("<h1 style='color:red;'>Unable to Add new Learner</h1>",E_USER_WARNING);
		}
	}
	else{
...
<div class="wrapper">
  <div id="formContent">
		<h2 id="sign" class="active">Add New Learner</h2>
