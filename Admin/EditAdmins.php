<html>
<link rel="stylesheet" type="text/css" href ="EditAdminLearner.css?v=1">
...
<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        try{
            ...
            if(!$result){
                trigger_error("<h1 style='color:red;'>Unable to Edit admin</h1>",E_USER_WARNING);            
            }
            else{
    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            <h2 id="sign" class="active">Edit Admin</h2>
