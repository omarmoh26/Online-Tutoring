...
<table border=2 class="table table-light">
  <thead class="thead-dark">
            <tr>
                ...
                <th>Edit</th>
                <th>Delete</th>
                <th> <a href="AddNewLearner.php"> ADD New Learner</a> </th>
            </tr>
        ...
        <?php
            ...
            $sql="SELECT * FROM user where type='learner' ";
        ...
        ?>
            ...
            <td> <a href=EditLearners.php?id=<?php echo $row['UserID'] ?>> EDIT</a> </td>
            <td> <a href=DeleteLearner.php?id=<?php echo $row['UserID'] ?>> DELETE</a> </td>
            </tr>
        <?php } ?>
    </thead>
</table>