...
<table border=2 class="table table-light">
  <thead class="thead-dark">
            <tr>
                ...
                <th>Edit</th>
                <th>Delete</th>
                <th> <a href="AddNewAdmin.php"> ADD New Admin</a> </th>
            </tr>
        ...
        <?php
            ...
            $sql="SELECT * FROM user where type='administrator' and UserID !=".$_SESSION['ID'];
        ...
        ?>
            ...
            <td> <a href=EditAdmins.php?id=<?php echo $row['UserID'] ?>> EDIT</a> </td>
            <td> <a href=DeleteOtherAdmins.php?id=<?php echo $row['UserID'] ?>> DELETE</a> </td>
            </tr>
        <?php } ?>
    </thead>    
</table>